...
screenshots. Diagrams are generated by `scripts/generate_figures.py` and follow
the style and wording rules in [docs/images/README.md](docs/images/README.md).
Verify affected links and examples; render changed diagrams and visually inspect
presentation changes before finalising. Preserve this standard without allowing
command inventories or session history to crowd the READMEs.
