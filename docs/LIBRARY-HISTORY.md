# Library history and earlier verification

**Historical snapshot retained on 10 September 2026.** The observations below
keep their original dates and scope. Earlier priorities, installation details
and branch status are not current instructions. Use [project status](../STATUS.md)
for the active checkpoint and [Workflows](WORKFLOWS.md) for commands.
...
the [lifecycle guide](LIFECYCLE.md), [release notes](../CHANGELOG.md), and
...
A [measured set-generation trial](SET-GENERATION-TRIAL.md) has reached its
...
The first [collection-planning increment](COLLECTION-PLANNER.md) saves
...
## Earlier next actions (superseded)
...
8. Record save/reload and real-session outcomes before expanding either crate or the
   intelligence layer; see the [Foundation v1 decision corpus](FOUNDATION-V1-DECISION-CORPUS.md).

Follow the canonical [workflow](WORKFLOWS.md) and
[safety model](SAFETY.md) rather than reconstructing commands from research
notes.
...
- [Near-duplicate pilot design](superpowers/specs/2026-07-08-near-dupe-pilot-design.md)
- [Sample intelligence audit](superpowers/specs/2026-07-07-sample-intelligence-audit.md)
